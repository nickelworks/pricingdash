...
from mapping import mapping_layout
    ...
    [
        dbc.Tabs(
            [
                ...
                dbc.Tab(label="Future Work", tab_id="tab-mapping", labelClassName="text-success font-weight-bold", activeLabelClassName="text-danger"),
